...
> arm64.) Replace `v0.2.2` below with the latest tag on the Releases page.
...
jobs:
  ctos:
    ...
    steps:
      ...
      - name: Install ctos
        run: cargo install --git https://github.com/leftvalue/ctos --tag v0.2.2   # or download a release binary
